...
<div class="not-prose rounded-box flex flex-col items-start gap-4 bg-base-200 p-4">
...
<div class="not-prose rounded-box bg-base-200 p-4">
    <x-form-control>
        <x-label
...
<div class="not-prose rounded-box flex flex-wrap gap-4 bg-base-200 p-4">
